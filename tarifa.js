...
tarifario (hogares con consumo mayor a ${topeConsumno}Kwh por mes tendrán un aumento del ${aumento}), cumplimos con informarle
que se ha ajustado el total a pagar, que será de $${pagoFinal}"` :

`"Debido a que su hogar ha tenido un consumo de ${consumoKWH}Kwh, en  base al ajuste
    tarifario (hogares con consumo mayor a ${topeConsumno}Kwh por mes tendrán un aumento del ${aumento}), 
    cumplimos con informarle que se le seguirá manteniendo el subsidio y el total a pagar será de $${pagoMes}"`;
console.log(mensaje); 